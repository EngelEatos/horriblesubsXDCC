...
class IrcSettingsLoader(JsonLoader):
    ...
    def get_bot_ranking(self):
        """return list bot ranking"""
        return self.get_value('bot_ranking', self.get_irc_settings())
    
    def set_bot_ranking(self, bot_ranking):
        """set bot ranking"""
        self.set_irc_settings(self.change_key('bot_ranking', bot_ranking, self.get_irc_settings()))
